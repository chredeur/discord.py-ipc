...
class Client:
    ...
    secret_key: Union[str, bytes]
        The secret key for your IPC server. Must match the server secret_key or requests will not go ahead,
        defaults to None
    """
    ...
    async def request(self, endpoint: str, timeout: float = 60.0, **kwargs):
